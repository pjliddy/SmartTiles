...
function updateThermostat(t, e) {
    t.find(".title2").html("&#10044; " + e.thermostatFanMode +", " + e.thermostatOperatingState), t.find(".icon.setpoint").html(e.setpoint + "&deg;"), t.find(".footer").html("<i class='fa fa-fw wi wi-thermostat'></i>" + e.temperature + "<i class='fa fa-fw wi wi-sprinkles'></i>" + e.humidity + "%")), t.attr("data-setpoint", e.setpoint)
}
