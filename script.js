...
(function(e) {
    ...
    var i = {
        giot: function(e, t) {
            ...
            var n = t.runtime, i = n.limitRow, s = n.limitCol, o = 0, u = 0, a = n.totalCol, f = n.totalRow, l = {}, c = n.holes, h = null, p = n.matrix, d = Math.max(s, i), v = null, m = null, g = s < i ? 1: 0, y = null, b = Math.min(s, i);
            for (var E in c) {
    ...
    window.freewall = function(n) {
        ...
        e.extend(u, {
            ...
            container: s,
            destroy: function() {
                var t = s.find(a.selector).removeAttr("id"), n = null, r = [];
                t.each(function(t, n) {
                    $item = e(n);
            ...
            fitHeight: function(n) {
                var o = s.find(a.selector).removeAttr("id"), l = null, h = [];
            ...
            fitZone: function(n, o) {
                var l = s.find(a.selector).removeAttr("id"), h = null, p = [];
...
function updateThermostat(t, e) {
    t.find(".title2").html("&#10044; " + e.thermostatFanMode +", " + e.thermostatOperatingState), t.find(".icon.setpoint").html(e.setpoint + "&deg;"), t.find(".footer").html("<i class='fa fa-fw wi wi-thermometer'></i>" + e.temperature + "&deg; <i class='fa fa-fw wi wi-sprinkles'></i>" + e.humidity + "%"), t.attr("data-setpoint", e.setpoint)
}
function sendCommand(t, e, i, a) {
    var o = getUrlParameter("access_token"), n = {
        type: t,
        device: e,
        command: i,
        value: a
...
function doPoll(t) {
    ...
    var e = getUrlParameter("access_token"), a = {
        ts: stateTS
    };
    e && (a.access_token = e), $.get("ping", a).done(function(e) {
        if ("refresh" == e.status && refresh(), clearWTFCloud(), t)
            t();
        else if (stateTS = e.ts, $(".refresh .footer").html(e.updated), "update" == e.status)
            for (i in e.data)
                updateTile(e.data[i])
    }).fail(function() {
        setWTFCloud()
...
function startTime() {
    if (document.getElementById("clock")) {
        ...
        e > 12 && (e -= 12);
        var i = t.getMinutes(), a = t.getSeconds();
